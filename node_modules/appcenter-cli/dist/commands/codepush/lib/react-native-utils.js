...
exports.getReactNativeVersion = exports.isValidPlatform = exports.isValidOS = exports.getHermesEnabled = exports.runHermesEmitBinaryCommand = exports.runReactNativeBundleCommand = exports.getReactNativeProjectAppVersion = exports.spawn = void 0;
const fs = require("fs");
...
function getHermesOSExe() {
    const hermesExecutableName = validation_utils_1.isLowVersion(getReactNativeVersion(), "0.63.0") ? "hermes" : "hermesc";
    switch (process.platform) {
        case "win32":
